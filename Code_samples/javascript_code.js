...
getToken(
  (err) => console.log("An error occurred submitting the request."),
  () => {
    let tokenResponse;
    try {
    ...
    const scoring_url =
      "https://us-south.ml.cloud.ibm.com/ml/v4/deployments/3553aed4-7284-4a5f-a70f-1c12334a241e/ai_service_stream?version=2021-05-01";
    apiPost(
      scoring_url,
